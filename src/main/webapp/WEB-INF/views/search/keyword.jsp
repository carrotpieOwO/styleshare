...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
	...
	<div class="col-md-4 my-3">
		...
		<a href="/style/${keyword.id}">
			<div class="style" >
			<img src="/media/${keyword.image1}" class="card-img-top style-photo" style="cursor:pointer;"/>
			<div class="row style-info align-items-center justify-content-center" style="width:80%">
				<p class="ml-4"><i class="fas fa-heart"></i> ${keyword.likeCount}</p>
				<p class="ml-3"><i class="fas fa-bookmark right-float"></i> ${keyword.clippingCount}</p>
			</div>
			 <c:if test="${not empty keyword.image2}">
			...
			<div id="user" class="card-body text-dark " style="height: 70px;">
				<div class="d-flex align-items-center">
					...
					<p class="img float-left mr-2">
						<img src="/media/${keyword.profile}" class="border rounded-circle" onError="javascript:this.src='/img/unknown.png'" width="36" height="36">
					</p>
					<p class="name clearfix " style="font-size: 11px;">${keyword.username}</p>
	                 <a href="/user/mypage/${keyword.username}" class="btn btn-dark text-light mb-auto ml-auto" style="cursor: pointer; z-index:10"><i class="fas fa-home"></i></a> 
				</div>
			</div>
